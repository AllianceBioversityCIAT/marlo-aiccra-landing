...
const features: Feature[] = [
  ...
  },
  {
    ...
    desc: 'Define and guide reporting processes step by step, so every project and cycle follows the same consistent path.',
  ...
  },
  {
    ...
    desc: 'Keep all reporting data in one place — accessible, organized, and ready for analysis whenever you need it.',
